...
- Use `next/link` for all navigational elements—including external URLs and protocols (`mailto:`, `tel:`)—to ensure consistent routing behavior and prefetch support; add `target`/`rel` attributes when opening in a new tab.
